...
function SidebarTrigger({
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent className="text-[0.72rem] p-2 bg-popover text-popover-foreground border shadow-md rounded-md" side="right" align="center">
        Toggle Sidebar
      </TooltipContent>
    </Tooltip>
  )
...
function SidebarMenuButton({
  ...
  return (
    <Tooltip>
      {comp}
      <TooltipContent
        className="text-[0.72rem] p-2 bg-popover text-popover-foreground border shadow-md rounded-md"
        side="right"
        align="center"
