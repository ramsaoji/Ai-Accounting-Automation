...
<head>
  ...
  <style>
    ...
    :root {
      --bg-main: #060913;
      --bg-sidebar: #0b1120;
      --bg-card: rgba(17, 24, 43, 0.95);
      --bg-card-hover: rgba(26, 36, 62, 0.98);
      --border-color: rgba(38, 55, 94, 0.6);
      --border-glow: rgba(251, 191, 36, 0.2);
      --text-main: #f8fafc;
      --text-muted: #94a3b8;
      --brand-gold: #fbbf24;
      --brand-gold-glow: rgba(251, 191, 36, 0.08);
      --green-accent: #10b981;
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .workspace-title h1 {
      ...
      font-weight: 700;
      letter-spacing: -0.02em;
      background: linear-gradient(to right, #ffffff, #ffe3a3);
    ...
    .highlights-panel {
      background: linear-gradient(135deg, rgba(251, 191, 36, 0.03) 0%, rgba(0,0,0,0) 100%);
    ...
    /* Visual Net Cashflow strength bar indicator */
    .trend-bar-wrapper {
      width: 80px;
      height: 6px;
    ...
    /* Print rules matching standard layouts */
    @media print {
