 ...
 */
function parsePriceLookup(worksheet: ExcelJS.Worksheet): Map<string, { costPrice: number; sellingPrice: number }> {
 ...
 */
function extractBlocks(worksheet: ExcelJS.Worksheet): { date: Date; startRow: number; endRow: number }[] {
